defmodule Mix.Tasks.Dialyzer.Plt do
  ...
  * `dialyzer: :plt_add_deps` - Bool - include the project's dependencies in the PLT. Defaults false.
  ...
  defp build_plt do
    ...
    args = List.flatten ["--plt_info", "-Wunmatched_returns", "-Werror_handling", "-Wrace_conditions", "-Wno_opaque", "--output_plt", "#{plt_file}", "--build_plt", include_pa, "--apps", include_apps, "-r", ex_lib_path]
